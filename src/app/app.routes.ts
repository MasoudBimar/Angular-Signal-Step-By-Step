...
export const routes: Routes = [
  ...
  { path: 'signal-injection-context', loadComponent: () => import('./04-signal-preliminary-injection-context/1-injection-context').then(m => m.InjectionContext) },
  { path: 'signal-injection-context/injection', loadComponent: () => import('./04-signal-preliminary-injection-context/4-signal-and-injection-context').then(m => m.SignalAndInjectionContext) },
  { path: 'signal-injection-context/effect', loadComponent: () => import('./04-signal-preliminary-injection-context/3-using-effects').then(m => m.UsingEffect) },
  ...
  { path: 'signal-apis/signal-api', loadComponent: () => import('./07-signal-apis/signal-api').then(m => m.SignalAPI) },
