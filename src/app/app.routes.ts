...
export const routes: Routes = [
  ...
  { path: 'rxjs-state-management', loadComponent: () => import('./02-rxjs-state-management/rxjs-state-management').then(m => m.RxJsStateManagement) },
  { path: 'rxjs-state-management/another-challenge', loadComponent: () => import('./02-rxjs-state-management/rxjs-state-management-another-chanllenge').then(m => m.rxJsStateManagement) },
  { path: 'signal-first-touch', loadComponent: () => import('./03-signal-first-touch/start-signal').then(m => m.StartSignal) },
  { path: 'signal-preliminary-injection-context', loadComponent: () => import('./04-signal-preliminary-injection-context/nx-welcome').then(m => m.NxWelcome) },
  { path: 'signal-preliminary-injection-context/injection', loadComponent: () => import('./04-signal-preliminary-injection-context/signal-and-injection').then(m => m.SignalAndInjection) },
  { path: 'signal-preliminary-injection-context/effect', loadComponent: () => import('./04-signal-preliminary-injection-context/how-to-use-effect').then(m => m.AppComponent) },
  { path: 'signal-computed-effect', loadComponent: () => import('./05-signal-computed-effect/nx-welcome').then(m => m.NxWelcome) },
  { path: 'rxjs-interop', loadComponent: () => import('./06-rxjs-interop/nx-welcome').then(m => m.NxWelcome) },
